...
if (isset($_POST['issue_book'])) {
    ...
    $result = mysqli_query($db, "INSERT INTO issue_books (student_id,book_id,book_issue_date) VALUES ('$student_id','$book_id','$book_issue_date')");
    mysqli_query($db, "UPDATE books SET availabele_qty=availabele_qty-1 WHERE id='$book_id'");
    if ($result) {
        mysqli_query($db, "UPDATE books SET availabele_qty=availabele_qty-1 WHERE id='$book_id'");
        ?>
                        ...
                        <div class="panel">
                            <div class="panel-content">
                                        ...
                                        <form class="form-inline" method="POST" action="">
                                            <div class="form-group">
                                                <select name="student_id" class="form-control">
                                                    ...
                                                    <?php
                                                    $result1 = mysqli_query($db, "SELECT * FROM students WHERE status='1'");
                                ...
                                if (isset($_POST['search'])) {
                                    $id = $_POST['student_id'];
                                    $result = mysqli_query($db, "SELECT * FROM students WHERE id='$id' AND status='1'");
                                                    ...
                                                    <form method="POST" action="">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="book_id" class="form-control">
                                                                <option value="">Select</option>
                                                                <?php
                                                                $result2 = mysqli_query($db, "SELECT * FROM books WHERE availabele_qty > 0");
