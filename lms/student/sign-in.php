...
if (isset($_POST['login'])) {
    ...
    $result = mysqli_query($db, "SELECT * FROM students WHERE email='$email' OR username='$email'");
    if (mysqli_num_rows($result) == 1) {
        ...
        if ( $hashpass == $row['password']) {
            if ($row['status'] == 1) {
                ...
                $error = "Your status is pending, please contact with librarian";
            }
        }else {
...
<head>
    ...
    <style>
    body{
        background: url(../assets/images/student-cover.jpg) !important;
...
<div class="wrap">
    ...
    <div class="page-body animated slideInDown">
        ...
        <div class="container">
            <div class="row">
                <a href="/lms" class="btn btn-primary">Back</a>
            </div>
        </div>
        
        <div class="logo">
        <div class="text-center" style="color:grey"><H3><b>LIBRARY MANAGEMENT SYSTEM</b></H3></div>
            <?php
            if (isset($error)) {
                ?>
