            ...
            if ($username_check_rows == 0) {
                if (strlen($username) >= 6) {
                    if (strlen($password) >= 6) {
                        ...
                        $query= "INSERT INTO students(fname, lname, roll, reg, email, username, password, phone, status) VALUES ('$fname','$lname','$roll','$reg','$email','$username','$hashpass','$phone','0')";
                    ...
                    $username_exits = "Username should be more than 5 character";
                }
            }else {
            ...
            <div class="panel mb-none">
                <div class="panel-content bg-scale-0">
                    <form method="POST" action="<?= $_SERVER['PHP_SELF'] ?>">
                        ...
                        <div class="form-group mt-md">
                            <span class="input-with-icon">
                                <input type="text" class="form-control" placeholder="01********" name="phone" pattern="01[1|3|4|6|7|9][0-9]{8}" value="<?= isset($phone) ? $phone:'' ?>">
